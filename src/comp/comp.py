...
print("Starts with D:")
a = [human.name for human in humans if 'd' in human.name[0].lower()]
print(a)

# Write a list comprehension that creates a list of names of everyone
# whose name ends in "e".
print("Ends with e:")
b = [human.name for human in humans if 'e' in human.name[len(human.name) - 1].lower()]
print(b)
...
g_index = alphabet.index('h')
c_to_g = alphabet[c_index:g_index]
print("Starts between C and G, inclusive:")
c = [human.name for human in humans if human.name[0].lower() in c_to_g]
print(c)
